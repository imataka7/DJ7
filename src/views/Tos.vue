  ...
  <div class="terms-of-service">
    ...
    <ul>
      ...
      <li>
        ...
        "Us" or "Our" in this Agreement) refers to DJ7.
      </li>
      <li><strong>Country</strong> refers to: Japan</li>
      ...
      <li>
        <strong>Website</strong> refers to DJ7, accessible from https://dj7.io
      </li>
      <li>
    ...
    <ul>
      <li>
        By visiting this page on our website: https://dj7.io/terms-of-service
      </li>
    </ul>
  </div>
</template>
